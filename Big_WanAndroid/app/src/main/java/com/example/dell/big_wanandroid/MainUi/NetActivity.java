                    ...
                    public void onNext(FlowBean flowBean) {
                        if (flowBean != null) {
                            ...
                            for (int i = 0; i < data1.size(); i++) {
                                ...
                                TextView label = (TextView) View.inflate(NetActivity.this, R.layout.item_label, null);
                                //获取数据
                                ...
                                label.setTextColor(ranColor);

                                label.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent intent = new Intent(NetActivity.this, NetWebActivity.class);
